package org.jam.recommendation.util.similarity;
...
public class SimilarityAnalysisJava {
    ...
    public static List<IndexedDataset> crossOccurrenceDownsampled(
        ...
        scala.collection.immutable.List l = SimilarityAnalysis.crossOccurrenceDownsampled(
                ...
                seed);
        return (List<IndexedDataset>) scala.collection.JavaConverters
                .seqAsJavaListConverter(l)
                .asJava();
    }
    ...
    public static List<IndexedDataset> cooccurrencesIDSs(
            ...
            ParOpts parOpts) {
        scala.collection.immutable.List l = SimilarityAnalysis.cooccurrencesIDSs(indexedDatasets,
                randomSeed, maxInterestingItemsPerThing, maxNumInteractions, parOpts);
        return (List<IndexedDataset>) scala.collection.JavaConverters
                .seqAsJavaListConverter(l)
                .asJava();
    }
